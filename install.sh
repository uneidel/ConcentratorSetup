...
IoTHub_name=$basehub$seq                             #IoT HubName
DeviceId=SomeFancyIdName                            # Concentrator
gitrepo=https://github.com/uneidel/iotminidash      #Public Github Repository for WebSite
LogicApp_name=$baselogicapp$seq
ServiceBus_name=$baseservicebus$seq
StorageAccount_name=$basestorage$seq
SBQueue_name=$basesbqueue$seq
WebApp_name=$basewebapp$seq
WebAppCName=$baseapp$seq
### end Define ###
...
az group deployment create --name $DEPLOYMENTNAME --resource-group $RG --template-file .\armtemplate.json \ 
 --parameters "{\"IoTHub_name\": {\"value\": \"$IoTHub_name\"},\"LogicApp_name\": {\"value\": \"$LogicApp_name\"},\"ServiceBus_name\": {\"value\": \"$ServiceBus_name\"},\"StorageAccount_name\": {\"value\": \"$StorageAccount_name\"},\"SBQueue_name\": {\"value\": \"$SBQueue_name\"},\"WebApp_name\": {\"value\": \"$WebApp_name\"},\"WebAppCName\": {\"value\": \"$WebAppCName\"}}" 
